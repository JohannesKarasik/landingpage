...
export default function Footer() {
    return (
        <>
            <footer className="flex flex-wrap justify-center lg:justify-between overflow-hidden gap-10 md:gap-20 py-16 px-6 md:px-16 lg:px-24 xl:px-32 text-gray-400 bg-[#0F0F12]">
                <div className="flex flex-wrap items-start gap-10 md:gap-15 xl:gap-35">
                    <a href="https://prebuiltui.com">
                        <Image
                            src='/Dermify (4)-cropped.svg'
                            alt="Logo"
                            width={103}
                            height={35}
                ...
                <div className="flex flex-col max-md:items-center max-md:text-center gap-2 items-end">
                    <p className="max-w-60">Helping med spas sell more and retain clients—at any stage of growth.</p>
                    ...
                    <p className="mt-3 text-center">© 2026 <a href="https://prebuiltui.com">Dermify.app</a></p>
                </div>
            </footer>
        </>
    );
